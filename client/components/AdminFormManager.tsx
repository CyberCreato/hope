                            ...
                            <div className="flex justify-between items-start">
                              <div className="space-y-2 flex-1">
                                ...
                                <div className="text-sm text-gray-600 space-y-1">
                                  <div><strong>Job:</strong> {job?.title || 'Unknown Job'}</div>
                                  <div><strong>Submitted by:</strong> {submitter?.name || 'Unknown User'}</div>
                                  <div><strong>Date:</strong> {new Date(submission.submittedAt).toLocaleString()}</div>
                                  {submission.updatedAt && (
                                    <div><strong>Updated:</strong> {new Date(submission.updatedAt).toLocaleString()}</div>
                                  )}
                                </div>
